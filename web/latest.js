    ...
    return function(e, t, n) {
        ...
        6: [function(e, t) {
            ...
            var i = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                ...
                p = d && d.canPlayType && "probably" === d.canPlayType('video/webm; codecs="vp8", vorbis'),
            ...
            ! function() {
                if (function(e, t) {
                        ...
                        n.encodePacket = function(e) {
                            ...
                            switch (e.type) {
                                case "error":
                                    var p = e.reason ? s(i, e.reason) : "",
                                        l = e.advice ? s(r, e.advice) : "";
                                    ("" !== p || "" !== l) && (d = p + ("" !== l ? "+" + l : ""));
                                    break;
                                case "message":
                                    "" !== e.data && (d = e.data);
                    ...
                    function n(e) {
                        if (typeof P.addEventListener != x) P.addEventListener("load", e, !1);
                        else if (typeof L.addEventListener != x) L.addEventListener("load", e, !1);
                        else if (typeof P.attachEvent != x) v(P, "onload", e);
                    ...
                    var k, C, E, T, O, _, x = "undefined",
                        ...
                        z = function() {
                            var e = typeof L.getElementById != x && typeof L.getElementsByTagName != x && typeof L.createElement != x,
                                ...
                                s = [0, 0, 0],
                                c = null;
                            if (typeof N.plugins != x && typeof N.plugins[D] == j) c = N.plugins[D].description, !c || typeof N.mimeTypes != x && N.mimeTypes[A] && !N.mimeTypes[A].enabledPlugin || (F = !0, a = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), s[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), s[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), s[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                            else if (typeof P[["Active"].concat("Object").join("X")] != x) try {
        ...
        11: [function(e, t) {
            ...
            o.inherits(n, c), n.prototype.start = function(e, t) {
                ...
                a(o, function(e, i) {
                    ...
                    } else o.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(i, n.config.harkOptions), n.localStreams.push(i), n.config.autoAdjustMic && (n.gainController = new u(i), n.setMicIfEnabled(.5)), i.onended = function() {}, n.emit("localStream", i);
        ...
        20: [function(e, t) {
                            ...
                            var o = function(e) {
                                ...
                                return Object.keys(e).forEach(function(n) {
                                    if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
                                        var o = e[n] = "object" == typeof e[n] ? e[n] : {
                                            ideal: e[n]
                                        };
            ...
            } else navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (u.log("This appears to be Edge"), a = "edge", s = parseInt(navigator.userAgent.match(/Edge\/(\d+).(\d+)$/)[2], 10), c = 12) : u.log("Browser does not appear to be WebRTC-capable");
            else u.log("This does not appear to be a browser"), a = "not a browser";
            var f = {};
            ...
            t.exports = function(e, t) {
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), sessionStorage.getScreenMediaJSExtensionId) chrome.runtime.sendMessage(sessionStorage.getScreenMediaJSExtensionId, {
                        ...
                        o[d] = [a, r ? constraint : null], window.postMessage({
                            type: "getScreen",
                            id: d
                        }, "*")
                    }
        ...
        27: [function(e, t, n) {
            ...
            n.toSessionSDP = function(e, t) {
                ...
                var o = t.sid || e.sid || Date.now(),
                    i = t.time || Date.now(),
                    r = ["v=0", "o=- " + o + " " + i + " IN IP4 0.0.0.0", "s=-", "t=0 0", "a=msid-semantic: WMS *"],
                    a = e.groups || [];
        ...
        28: [function(e, t, n) {
            ...
            n._setIdCounter = function(e) {
                ...
                "application" == p.media && (l.description = {
                ...
                if (m && (l.name = m.substr(6)), i.findLine("a=sendrecv", u, d) ? l.senders = "both" : i.findLine("a=sendonly", u, d) ? l.senders = o[s][c].sendonly : i.findLine("a=recvonly", u, d) ? l.senders = o[s][c].recvonly : i.findLine("a=inactive", u, d) && (l.senders = "none"), "rtp" == f.descType) {
                    ...
                    var C = i.findLines("a=ssrc:", u),
                        E = f.sources = i.sources(C || []),
                        T = i.findLine("a=msid:", u);
                    if (T) {
                        var O = i.msid(T);
                ...
                var _ = i.findLines("a=fingerprint:", u, d),
                    x = i.findLine("a=setup:", u, d);
                _.forEach(function(e) {
                    var t = i.fingerprint(e);
                    x && (t.setup = x.substr(8)), h.fingerprints.push(t)
                });
                var j = i.findLine("a=ice-ufrag:", u, d),
                    D = i.findLine("a=ice-pwd:", u, d);
                if (j && D) {
        ...
        42: [function(e, t) {
            ...
            "lodash._baseisequal": 47,
            "lodash._bindcallback": 45,
            "lodash.isarray": 35,
            "lodash.pairs": 48
        }],
        49: [function(e, t) {
        ...
        47: [function(e, t) {
            ...
            var d = e("lodash.isarray"),
                p = e("lodash.istypedarray"),
                l = e("lodash.keys"),
                f = "[object Arguments]",
                h = "[object Array]",
                m = "[object Boolean]",
        ...
        46: [function(e, t) {
            ...
            "lodash._getnative": 50,
            "lodash.isarguments": 51,
            "lodash.isarray": 35
        }]
    }, {}, [1])(1)
});